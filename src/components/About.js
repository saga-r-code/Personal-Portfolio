      ...
      <div className="w-full md:w-[80%] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4">
            <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-emerald-400 to-blue-500 bg-clip-text text-transparent inline-block">
          ...
          <div className="bg-gray-900/30 backdrop-blur-lg rounded-2xl p-8 border border-gray-700/50 space-y-6">
