        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="bg-gray-900/30 backdrop-blur-lg sm:text-lg rounded-2xl p-5 sm:p-8 border border-gray-700/50 space-y-6">
            <p className="text-gray-300  leading-relaxed">
              I&apos;m Sagar Shah, a passionate beginner on an exciting journey
              into the world of web development. Like many of you, I started
              from scratch, armed with curiosity and determination to learn
              coding.
            </p>

            <p className="text-gray-300 leading-relaxed">
              Currently, I&apos;m exploring and learning Backend Development and
              how to make production ready code. Every day is a new opportunity
              to learn something new, and I believe that with dedication and
              consistent practice, anyone can become a great developer.
            ...
            <p className="text-gray-300  leading-relaxed">
              When I&apos;m not coding, I&apos;m exploring tech tutorials,
              participating in coding communities, and working on small projects
              to improve my skills. If you&apos;re also starting your coding
              journey, remember that the most important step is to begin, and
